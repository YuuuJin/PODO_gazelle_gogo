...
//    printf("\n=====================check ROS steps ====================\n");
    ...
    if(index==0)
    {
        if(userData->ros_footsteps[index].step_phase == 0)
        {
        ...
        curfoot = SDB[step_phase].Fpos;
        prevfoot = SDB[step_phase - 1].Fpos;

        curlr = -SDB[step_phase].swingFoot;
    }else
    {
